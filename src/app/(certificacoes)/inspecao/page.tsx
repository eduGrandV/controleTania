          ...
          <div className="flex gap-1 bg-gray-800/50 p-1 rounded-xl">
            {[
              ...
              <button
                ...
                className={`flex-1 py-3 px-2 sm:px-4 text-xs sm:text-sm font-bold uppercase rounded-lg transition-all duration-300 ${
                  activeTab === tab.id
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <SignatureCell
                          sig={preOpInfo.coordinator}
                          onSign={() =>
                            handleSignatureCoordinator("/raivans.png")
                          }
                          onUpload={(e: any) =>
                            e.target.files &&
                            handleSignatureCoordinator(
                              URL.createObjectURL(e.target.files[0]),
                            )
                          }
                          onRemove={() => handleSignatureCoordinator(null)}
                        />
                      </div>
                    </div>
                  </div>
